...
void replyToPC() {
  ...
  if (newDataFromPC) {
    if (!arretUrgenceX && !arretUrgenceY && !arretUrgenceZ) { //Le déplacement s'est bien déroulé
    ...
    else { //Le système a touché un capteur fin de course
